  ...
  <div class="app-container search-table-box aidex-table">
      ...
      <div class="filter-container">
        <div class="search_box">
          <el-form :model="queryParams" ref="queryForm" label-width="120px">
            <el-row :gutter="16">
              <el-col :md="6">
                <el-form-item label="导入模型名称" prop="name">
                  <el-input
                    v-model="queryParams.name"
                    placeholder="请输入导入模型名称"
                    clearable
    ...
    <el-card shadow="never" >
        ...
        <el-row>
          <el-col :span="8">
            <div class="card-header">
              <span class="erp-header-text">导入模型信息</span>
            </div>
          </el-col>
          <el-col :span="16">
      ...
      <el-table
        ...
        :height="tableHeight"
      >
        <el-table-column prop="name" label="导入模型名称" :show-overflow-tooltip="true" width="240"></el-table-column>
            ...
            <el-row :gutter="24">
              ...
              <el-col :span="12">
                <el-form-item label="模型名称" prop="name">
                  <el-input v-model="form.name" placeholder="请输入导入模型名称" />
                </el-form-item>
              </el-col>
...
<script setup name="importModel">
  import { addModel, delModel, getModel, listModel, updateModel, listEntity } from "@/api/system/importModel";
  ...
  const data = reactive({
    ...
    rules: {
      name: [{ required: true, message: "导入模型名称不能为空", trigger: "blur" }],
    },
  });
  ...
  function getList() {
    loading.value = true;
    queryParams.value.modelType = 'import';
