    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="字段信息" name="columnInfo">
        <el-table ref="dragTable" :data="columns" row-key="columnId" :max-height="tableHeight">
          ...
          <el-table-column label="敏感字段" min-width="5%">
            <template #default="scope">
              <el-checkbox true-label="1" false-label="0" v-model="scope.row.isSecure"></el-checkbox>
            </template>
          </el-table-column>
          <el-table-column label="是否唯一" min-width="5%">
            <template #default="scope">
...
function close() {
  const obj = { path: "/system/tool/gen", query: { t: Date.now(), pageNum: route.query.pageNum } };
