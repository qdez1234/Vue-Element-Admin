<template>
    <el-form ref="ruleFormRef" style="max-width: 600px" status-icon label-width="auto" class="demo-ruleForm">
        ...
        <el-form-item label="标签对齐" v-if="computedModel(['form', 'ex-dialog'])">
        ...
        <el-form-item label="标签宽度" v-if="computedModel(['form', 'ex-dialog'])">
            <el-input v-model="modelValue.labelWidth" type="number" autocomplete="off" />
        </el-form-item>

        <el-form-item label="弹窗宽度" v-if="computedModel(['ex-dialog'])">
            <el-input v-model="modelValue.width" autocomplete="off" />
        </el-form-item>

        <el-form-item label="弹窗高度" v-if="computedModel(['ex-dialog'])">
            <el-input v-model="modelValue.height" autocomplete="off" />
        </el-form-item>

        <el-form-item label="点击窗口外关闭" v-if="computedModel(['ex-dialog'])">
            <el-switch v-model="modelValue.close" />
        </el-form-item>
