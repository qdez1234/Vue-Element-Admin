...
import agDialog from "@/views/system/table/config/dialog"
 ...
 */
const reportGrid = () => {
    ExGridConfigRef.value.handleOpen({ data: props.modelValue.gridColDefs, model: props.modelValue.model, rowSelection: props.modelValue.rowSelection })
}
/**
 * 计算是否在当前组件里面
 * @param model 
