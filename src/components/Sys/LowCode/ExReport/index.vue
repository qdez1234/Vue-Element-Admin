<template>
    <div :class="['tagBox', (disabled || PageDisabled) ? 'disabled' : '', `tag-${mondelId}`]" @click="handleOpen"
        ...
        <div class="left">
            ...
            <el-input class="keyword-input" :disabled="PageDisabled" v-model="keyword" @input="HandelQuery" :placeholder="PageDisabled?placeholder:'请输入关键字查询'"></el-input>
        </div>
        <div class="right">
    ...
    <el-dialog v-model="dialogVisible" draggable title="数据查询" :close-on-click-modal="false" :append-to-body="true"
        ...
        <div class="content">
            <div class="search">
                <span>关键字</span>
                <el-input class="keyword-input" v-model="keyword" @input="HandelQuery" :placeholder="PageDisabled?placeholder:'请输入关键字查询'"
